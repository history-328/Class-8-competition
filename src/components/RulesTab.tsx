    ...
    <div className="p-6 max-w-4xl mx-auto text-slate-300">
      <div className="bg-slate-900/80 p-8 rounded-2xl border border-slate-700 shadow-xl prose prose-invert prose-blue max-w-none">
        ...
        <ul className="list-disc pl-6 space-y-2 mb-6">
          ...
          <li><strong>赛制核心：</strong>积分制+胜负分组，小组积分赛采用BO2赛制，加赛采用BO1赛制，淘汰赛采用BO3赛制，最终根据积分排名决出冠亚季军。</li>
          <li><strong>积分规则：</strong>获胜1场积2分，打平（未加赛）各积1分，加赛获胜积2分、加赛失利积0分；败者组失利1场将直接淘汰，胜者组失利则掉入败者组。</li>
        ...
        <p className="mb-2"><strong>抽签规则：</strong>赛前5支队伍教练抽签，抽取1-5号，其中抽到5号“轮空签”的队伍直接积2分，其余4支队伍两两对阵。</p>
        ...
        <p className="mb-2"><strong>对阵规则：</strong>采用“积分相近对阵”原则，轮空队伍轮换，与第二轮小组赛抽签，默认为本轮1号，剩余4只队伍中抽取到5号“轮空签”的队伍本轮轮空直接积2分，其余4支队伍两两对阵。</p>
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li><strong>轮空规则：</strong>瑞士轮前2轮，每支队伍仅轮空1次，轮空顺序通过抽签确定，避免单支队伍多次轮空；第三轮胜负组轮空，按积分排序确定，积分高者轮空</li>
